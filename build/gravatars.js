...
var _user$project$Model$RemoveEmail = function (a) {
	return {ctor: 'RemoveEmail', _0: a};
};
var _user$project$Model$InsertEmail = function (a) {
	return {ctor: 'InsertEmail', _0: a};
};
			...
			case 'InsertEmail':
				return {
					...
					_0: {
						...
						_0: _p3,
						_1: _p4,
						_2: A2(_elm_lang$core$Set$insert, _p2._0, _p5)
					},
			...
			case 'RemoveEmail':
				return {
					...
					_0: {
						...
						_0: _p3,
						_1: _p4,
						_2: A2(_elm_lang$core$Set$remove, _p2._0, _p5)
					},
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: {ctor: '_Tuple3', _0: _p2._0, _1: _p4, _2: _p5},
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$State$init = function (_p6) {
	var _p7 = _p6;
	return {
		ctor: '_Tuple2',
		_0: {
			...
			_0: '',
			_1: _p7._0,
			_2: _elm_lang$core$Set$fromList(_p7._1)
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};

var _user$project$View$makeHashUrl = function (edit) {
	var prefix = edit ? '#_' : '#$';
	return function (_p0) {
		return A2(
			F2(
...
var _user$project$View$gravatarUrl = function () {
	var template = function (hash) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'https://www.gravatar.com/avatar/',
			A2(_elm_lang$core$Basics_ops['++'], hash, '?s=256'));
	};
	return function (_p1) {
		return template(
...
var _user$project$View$viewEmail = F2(
	function (edit, email) {
		return A2(
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							...
							_0: _elm_lang$html$Html_Attributes$src(
								_user$project$View$gravatarUrl(email)),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Model$RemoveEmail(email)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$View$view = function (_p2) {
	var _p3 = _p2;
	var _p6 = _p3._2;
	var _p5 = _p3._1;
	var _p4 = _p3._0;
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('emails'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(
							_elm_lang$core$List$map,
							_user$project$View$viewEmail(_p5),
							_elm_lang$core$Set$toList(_p6)),
						_elm_lang$core$Native_Utils.eq(
							_elm_lang$core$Set$size(_p6),
							0) ? {
							ctor: '::',
							_0: A2(_user$project$View$viewEmail, _p5, ''),
							_1: {ctor: '[]'}
						} : {ctor: '[]'})),
				_1: {ctor: '[]'}
			},
					...
					_elm_lang$html$Html$form,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onSubmit(
								_user$project$Model$InsertEmail(_p4)),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('gravatar@email.com'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Model$UpdateEmail),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Insert a gravatar email'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
											...
											_elm_lang$html$Html$a,
											{
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Attributes$href(
														A2(_user$project$View$makeHashUrl, true, _p6)),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Edit Link'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href(
															A2(_user$project$View$makeHashUrl, false, _p6)),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Show Link'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
